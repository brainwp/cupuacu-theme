<?php /* Template Name: Pagina com Menu */ get_header('page'); ?>
...
<div id="conteudo-dir">
	...
	<div id="cont-geral-sobre">
			<div id="cont-links" class="sobre-nos">
			<ul class="cont-links">
				<li><a href="<?php echo home_url( '/historia' ); ?>">Historia</a></li>
				<li class="espacador">|</li>
				<li><a href="<?php echo home_url( '/sobre-nos' ); ?>">Sobre Nos</a></li>
				</ul>
			<ul class="cont-links">
				<li><a href="<?php echo home_url( '/fundadores' ); ?>">Fundadores</a></li>
				<li class="espacador">|</li>
				<li><a href="<?php echo home_url( '/integrantes' ); ?>">Integrantes</a></li>
			</ul>	
			</div>
					<?php
